...
// 이 오 메세지는 보통 컬렉션 list 요소를 반복문 안에서 돌리면서 값을 삭제하고자 할 때 발생
// 보통 반복문 안에서 remove() 메소드를 호출 할 때 발생
...
// 이를 해결하기 위해서는 --> Iterator(반복자)를 사용하여 순회하 --> 그때, iter.remove() 메소드로 처리해야 한다
import java.util.ArrayList;
import java.util.Iterator;

public class Collection_FrameworkArrayListWithIteratorWhyUse {
